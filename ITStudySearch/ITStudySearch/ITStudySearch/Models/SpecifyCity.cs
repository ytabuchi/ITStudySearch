...
namespace ITStudySearch.Models
{
    static class SpecifyCity
    {
        ...
        public static string GetCity(string address)
        {
            ...
            // 都道府県が省略されて東京都、大阪府、京都府、神奈川県、愛知県、のみ、政令指定都市(?)をマッチさせます。
            ...
            const string okayamaRegex = "(岡山市|倉敷市|津山市|玉野市|笠岡市|井原市|総社市|高梁市|新見市|備前市|瀬戸内市|赤磐市|真庭市|美作市|浅口市)";
            ...
            if (m.Value != "")
                ...
                city = "北海道";
            else if (Regex.IsMatch(address, okayamaRegex))
                city = "岡山県";
